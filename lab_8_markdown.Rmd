...
### Convert the data to spaitial point patterns (combination of point data and the bounding window)
...
#do not allow the points outside of the window
...
# 5 region horizontally 5 region vertically
oil_qt # the data are not spatially evenely distributed

# reject Null, not evenly distributed
plot(all_ppp)
...
#Our data have higher proportion of point pairs nearlest neighbors compared to CSR data.
